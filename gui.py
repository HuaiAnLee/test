...
# if __name__ == '__main__':
#     multiprocessing.set_start_method("spawn")
#     sub_area = (1310, 1912, 0, 1080)

#     # ptyhon gui.py -dir_path=video_dir_path -sub_area_xmin=0 

#     # 创建 ArgumentParser 对象
#     parser = argparse.ArgumentParser(description='Description of your program.')
#     # 添加参数
#     parser.add_argument('-dir_path', dest='video_dir_path', type=str, help='Description of video dir path argument.')
#     # 解析命令行参数
#     args = parser.parse_args()

#     video_dir_path = args.video_dir_path
#     video_path = sys.argv[1]
#     # 把 vide_path 转成 string
